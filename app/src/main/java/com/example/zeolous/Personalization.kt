...
class Personalization : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var flag  = arrayOf(true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true)
        ...
        binding_p.personal1.setOnClickListener{
            ...
            if(flag[0]) {
                ...
                index++
                binding_p.personal1.backgroundTintList=getColorStateList(R.color.holo_blue_bright)
                flag[0] = false
            }else{
        ...
        binding_p.personal2.setOnClickListener{
            ...
            if(flag.get(1)) {
                ...
                index++
                binding_p.personal2.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[1]= false
            }else{
        ...
        binding_p.personal3.setOnClickListener{
            ...
            if(flag[2]) {
                ...
                index++
                binding_p.personal3.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[2] = false
            }else{
                binding_p.personal3.backgroundTintList=getColorStateList(android.R.color.white)
                flag[2] = true
                index--
        ...
        binding_p.personal4.setOnClickListener{
            ...
            if(flag[3]) {
                ...
                index++
                binding_p.personal4.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[3] = false
            }else{
                binding_p.personal4.backgroundTintList=getColorStateList(android.R.color.white)
                flag[3] = true
                index--
        ...
        binding_p.personal6.setOnClickListener{
            ...
            if(flag[5]) {
                ...
                index++
                binding_p.personal6.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[5] = false
            }else{
                binding_p.personal6.backgroundTintList=getColorStateList(android.R.color.white)
                flag[5] = true
                index--
        ...
        binding_p.personal7.setOnClickListener{
            ...
            if(flag[6]) {
                ...
                index++
                binding_p.personal7.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[6] = false
            }else{
                binding_p.personal7.backgroundTintList=getColorStateList(android.R.color.white)
                flag[6] = true
                index--
        ...
        binding_p.personal9.setOnClickListener{
            ...
            if(flag[8]) {
                ...
                index++
                binding_p.personal9.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[8] = false
            }else{
                binding_p.personal9.backgroundTintList=getColorStateList(android.R.color.white)
                flag[8] = true
                index--
        ...
        binding_p.personal11.setOnClickListener{
            ...
            if(flag[10]) {
                ...
                index++
                binding_p.personal11.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[10] = false
            }else{
                binding_p.personal11.backgroundTintList=getColorStateList(android.R.color.white)
                flag[10] = true
                index--
        ...
        binding_p.personal12.setOnClickListener{
            ...
            if(flag[11]) {
                ...
                index++
                binding_p.personal12.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[11] = false
            }else{
                binding_p.personal12.backgroundTintList=getColorStateList(android.R.color.white)
                flag[11] = true
                index--
        ...
        binding_p.personal13.setOnClickListener{
            ...
            if(flag[12]) {
                ...
                index++
                binding_p.personal13.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[12] = false
            }else{
                binding_p.personal13.backgroundTintList=getColorStateList(android.R.color.white)
                flag[12] = true
                index--
        ...
        binding_p.personal14.setOnClickListener{
            ...
            if(flag[13]) {
                ...
                index++
                binding_p.personal14.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[13] = false
            }else{
                binding_p.personal14.backgroundTintList=getColorStateList(android.R.color.white)
                flag[13] = true
                index--
        ...
        binding_p.personal15.setOnClickListener{
            ...
            if(flag[14]) {
                ...
                index++
                binding_p.personal15.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[14] = false
            }else{
                binding_p.personal15.backgroundTintList=getColorStateList(android.R.color.white)
                flag[14] = true
                index--
        ...
        binding_p.personal16.setOnClickListener{
            ...
            if(flag[15]) {
                ...
                index++
                binding_p.personal16.backgroundTintList=getColorStateList(android.R.color.holo_blue_bright)
                flag[15] = false
            }else{
                binding_p.personal16.backgroundTintList=getColorStateList(android.R.color.white)
                flag[15] = true
                index--
        ...
        binding_p.button2.setOnClickListener{
            ...
            database = FirebaseDatabase.getInstance().getReference("UsersInterests")
